...
is_deeply ($am_pm, [qw( a.m. p.m. )], 'AM PM narrow');
$am_pm = $locale->am_pm_format_wide();
is_deeply ($am_pm, { am => 'a. m.', noon => 'migdia', pm => 'p. m.' }, 'AM PM format wide');
$am_pm = $locale->am_pm_format_abbreviated();
is_deeply ($am_pm, { am => 'a. m.', noon => 'migdia', pm => 'p. m.' }, 'AM PM format abbreviated');
$am_pm = $locale->am_pm_format_narrow();
is_deeply ($am_pm, { am => 'a.m.', noon => 'md', pm => 'p.m.' }, 'AM PM format narrow');
$am_pm = $locale->am_pm_stand_alone_wide();
is_deeply ($am_pm, { am => 'a. m.', noon => 'migdia', pm => 'p. m.' }, 'AM PM stand alone wide');
$am_pm = $locale->am_pm_stand_alone_abbreviated();
is_deeply ($am_pm, { am => 'a. m.', noon => 'migdia', pm => 'p. m.' }, 'AM PM stand alone abbreviated');
$am_pm = $locale->am_pm_stand_alone_narrow();
is_deeply ($am_pm, { am => 'a.m.', noon => 'md', pm => 'p.m.' }, 'AM PM stand alone narrow');
