...
is($locale->measurement_system_name('us'), 'imperial', 'Measurement system name English US');
is($locale->measurement_system_name('uk'), 'anglosaxó', 'Measurement system name English UK');

is($locale->transform_name('Numeric'), 'Numèric', 'Transform name from string');