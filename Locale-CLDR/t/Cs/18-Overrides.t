...
is_deeply ($am_pm, [qw( a.m. p.m. )], 'Islamic AM PM narrow');
$am_pm = $locale->am_pm_format_wide();
is_deeply ($am_pm, { am => 'a. m.', noon => 'migdia', pm => 'p. m.' }, 'Islamic AM PM format wide');
$am_pm = $locale->am_pm_format_abbreviated();
is_deeply ($am_pm, { am => 'a. m.', noon => 'migdia', pm => 'p. m.' }, 'Islamic AM PM format abbreviated');
$am_pm = $locale->am_pm_format_narrow();
is_deeply ($am_pm, { am => 'a.m.', noon => 'md', pm => 'p.m.' }, 'Islamic AM PM format narrow');
$am_pm = $locale->am_pm_stand_alone_wide();
is_deeply ($am_pm, { am => 'a. m.', noon => 'migdia', pm => 'p. m.' }, 'Islamic AM PM stand alone wide');
$am_pm = $locale->am_pm_stand_alone_abbreviated();
is_deeply ($am_pm, { am => 'a. m.', noon => 'migdia', pm => 'p. m.' }, 'Islamic AM PM stand alone abbreviated');
$am_pm = $locale->am_pm_stand_alone_narrow();
is_deeply ($am_pm, { am => 'a.m.', noon => 'md', pm => 'p.m.' }, 'Islamic AM PM stand alone narrow');
...
is($date_time_format, "EEEE, d MMMM 'de' y, H:mm:ss zzzz", 'Islamic Date Time Format Full');
$date_time_format = $locale->datetime_format_long;
is($date_time_format, "d MMMM 'de' y, H:mm:ss z", 'Islamic Date Time Format Long');
