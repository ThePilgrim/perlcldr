...
is($locale->unit(1, 'arc-minute', 'short'), '1 min', 'English short 1 minute');
is($locale->unit(2, 'arc-minute', 'short'), '2 min', 'English short 2 minutes');
is($locale->unit(1, 'arc-minute'), '1 minute', 'English long 1 minute');
is($locale->unit(2, 'arc-minute'), '2 minutes', 'English long 2 minutes');
...
is($locale->unit(1, 'arc-second', 'short'), '1 sec', 'English short 1 second');
is($locale->unit(2, 'arc-second', 'short'), '2 secs', 'English short 2 seconds');
is($locale->unit(1, 'arc-second'), '1 second', 'English long 1 second');
is($locale->unit(2, 'arc-second'), '2 seconds', 'English long 2 seconds');
...
is($locale->unit(2, 'g-force', 'narrow'), '2G', 'English narrow 2 g-force');
...
is($locale->unit(1, 'meter', 'narrow'), '1m', 'English narrow 1 metre');
is($locale->unit(2, 'meter', 'narrow'), '2m', 'English narrow 2 metres');
is($locale->unit(1, 'meter', 'short'), '1 m', 'English short 1 metre');
is($locale->unit(2, 'meter', 'short'), '2 m', 'English short 2 metres');
is($locale->unit(1, 'meter'), '1 metre', 'English long 1 metre');
is($locale->unit(2, 'meter'), '2 metres', 'English long 2 metres');
is($locale->unit(1, 'meter-per-second', 'narrow'), '1m/s', 'English narrow 1 metre per second');
is($locale->unit(2, 'meter-per-second', 'narrow'), '2m/s', 'English narrow 2 metres per second');
is($locale->unit(1, 'meter-per-second', 'short'), '1 m/s', 'English short 1 metre per second');
is($locale->unit(2, 'meter-per-second', 'short'), '2 m/s', 'English short 2 metres per second');
is($locale->unit(1, 'meter-per-second'), '1 metre per second', 'English long 1 metre per second');
is($locale->unit(2, 'meter-per-second'), '2 metres per second', 'English long 2 metres per second');
...
is($locale->unit(1, 'millisecond', 'narrow'), '1 ms', 'English narrow 1 millisecond');
is($locale->unit(2, 'millisecond', 'narrow'), '2 ms', 'English narrow 2 milliseconds');
...
is($locale->unit(1, 'square-meter', 'narrow'), '1 m²', 'English narrow 1 square metre');
is($locale->unit(2, 'square-meter', 'narrow'), '2 m²', 'English narrow 2 square metres');
is($locale->unit(1, 'square-meter', 'short'), '1 m²', 'English short 1 square metre');
