...
is($locale->unit(1, 'g-force', 'narrow'), '1 force g', 'French narrow 1 g-force');
is($locale->unit(2, 'g-force', 'narrow'), '2 force g', 'French narrow 2 g-force');
...
is($locale->unit(1, 'inch-ofhg', 'narrow'), '1 inHg', 'French narrow 1 inch of mercury');
is($locale->unit(2, 'inch-ofhg', 'narrow'), '2 inHg', 'French narrow 2 inches of mercury');
is($locale->unit(1, 'inch-ofhg', 'short'), '1 inHg', 'French short 1 inch of mercury');
is($locale->unit(2, 'inch-ofhg', 'short'), '2 inHg', 'French short 2 inches of mercury');
is($locale->unit(1, 'inch-ofhg'), '1 pouce de mercure', 'French long 1 inch of mercury');
is($locale->unit(2, 'inch-ofhg'), '2 pouces de mercure', 'French long 2 inches of mercury');
...
is($locale->unit(1, 'light-year', 'narrow'), '1 al', 'French narrow 1 light year');
is($locale->unit(2, 'light-year', 'narrow'), '2 al', 'French narrow 2 light years');
...
is($locale->unit(1, 'meter-per-second', 'narrow'), '1 m/s', 'French narrow 1 meter per second');
...
is($locale->unit(1, 'mile-per-hour', 'narrow'), '1 mi/h', 'French narrow 1 mile per hour');
is($locale->unit(2, 'mile-per-hour', 'narrow'), '2 mi/h', 'French narrow 2 miles per hour');
...
is($locale->unit(1, 'minute', 'narrow'), '1min', 'French narrow 1 minute');
is($locale->unit(2, 'minute', 'narrow'), '2min', 'French narrow 2 minutes');
