...
is_deeply ($am_pm, [qw( ص م )], 'AM PM narrow');
$am_pm = $locale->am_pm_format_wide();
is_deeply ($am_pm, { am => 'ص', noon => 'ظ', pm => 'م' }, 'AM PM format wide');
$am_pm = $locale->am_pm_format_abbreviated();
is_deeply ($am_pm, { am => 'ص', noon => 'ظ', pm => 'م' }, 'AM PM format abbreviated');
$am_pm = $locale->am_pm_format_narrow();
is_deeply ($am_pm, { am => 'ص', noon => 'ظ', pm => 'م' }, 'AM PM format narrow');
$am_pm = $locale->am_pm_stand_alone_wide();
is_deeply ($am_pm, { am => 'ص', noon => 'ظ', pm => 'م' }, 'AM PM stand alone wide');
$am_pm = $locale->am_pm_stand_alone_abbreviated();
is_deeply ($am_pm, { am => 'ص', noon => 'ظ', pm => 'م' }, 'AM PM stand alone abbreviated');
$am_pm = $locale->am_pm_stand_alone_narrow();
is_deeply ($am_pm, { am => 'ص', noon => 'ظ', pm => 'م' }, 'AM PM stand alone narrow');
...
$am_pm = $locale->am_pm_narrow();
is_deeply ($am_pm, [qw( ص م )], 'Islamic AM PM narrow');
$am_pm = $locale->am_pm_format_wide();
is_deeply ($am_pm, { am => 'ص', noon => 'ظ', pm => 'م' }, 'Islamic AM PM format wide');
$am_pm = $locale->am_pm_format_abbreviated();
is_deeply ($am_pm, { am => 'ص', noon => 'ظ', pm => 'م' }, 'Islamic AM PM format abbreviated');
$am_pm = $locale->am_pm_format_narrow();
is_deeply ($am_pm, { am => 'ص', noon => 'ظ', pm => 'م' }, 'Islamic AM PM format narrow');
$am_pm = $locale->am_pm_stand_alone_wide();
is_deeply ($am_pm, { am => 'ص', noon => 'ظ', pm => 'م' }, 'Islamic AM PM stand alone wide');
$am_pm = $locale->am_pm_stand_alone_abbreviated();
is_deeply ($am_pm, { am => 'ص', noon => 'ظ', pm => 'م' }, 'Islamic AM PM stand alone abbreviated');
$am_pm = $locale->am_pm_stand_alone_narrow();
is_deeply ($am_pm, { am => 'ص', noon => 'ظ', pm => 'م' }, 'Islamic AM PM stand alone narrow');
