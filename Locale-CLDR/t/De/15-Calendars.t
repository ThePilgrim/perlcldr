...
is_deeply ($am_pm, [qw( vorm. nachm. )], 'AM PM wide');
$am_pm = $locale->am_pm_abbreviated();
is_deeply ($am_pm, [qw( vorm. nachm. )], 'AM PM abbreviated');
$am_pm = $locale->am_pm_narrow();
is_deeply ($am_pm, [qw( vorm. nm. )], 'AM PM narrow');
$am_pm = $locale->am_pm_format_wide();
is_deeply ($am_pm, { morning1 => q{morgens}, pm => q{nachm.}, night1 => q{nachts}, morning2 => q{vormittags}, evening1 => q{abends}, afternoon2 => q{nachmittags}, am => q{vorm.}, afternoon1 => q{mittags}, midnight => q{Mitternacht} }, 'AM PM format wide');
$am_pm = $locale->am_pm_format_abbreviated();
is_deeply ($am_pm, { morning1 => q{morgens}, pm => q{nachm.}, night1 => q{nachts}, morning2 => q{vormittags}, evening1 => q{abends}, afternoon2 => q{nachmittags}, am => q{vorm.}, afternoon1 => q{mittags}, midnight => q{Mitternacht} }, 'AM PM format abbreviated');
$am_pm = $locale->am_pm_format_narrow();
is_deeply ($am_pm, { morning1 => q{morgens}, pm => q{nm.}, night1 => q{nachts}, morning2 => q{vormittags}, evening1 => q{abends}, afternoon2 => q{nachmittags}, am => q{vorm.}, afternoon1 => q{mittags}, midnight => q{Mitternacht} }, 'AM PM format narrow');
$am_pm = $locale->am_pm_stand_alone_wide();
is_deeply ($am_pm, { afternoon1 => q{Mittag}, midnight => q{Mitternacht}, afternoon2 => q{Nachmittag}, am => q{vorm.}, evening1 => q{Abend}, night1 => q{Nacht}, pm => q{nachm.}, morning2 => q{Vormittag}, morning1 => q{Morgen} }, 'AM PM stand alone wide');
$am_pm = $locale->am_pm_stand_alone_abbreviated();
is_deeply ($am_pm, { afternoon1 => q{Mittag}, midnight => q{Mitternacht}, afternoon2 => q{Nachmittag}, am => q{vorm.}, evening1 => q{Abend}, night1 => q{Nacht}, pm => q{nachm.}, morning2 => q{Vormittag}, morning1 => q{Morgen} }, 'AM PM stand alone abbreviated');
$am_pm = $locale->am_pm_stand_alone_narrow();
is_deeply ($am_pm, { afternoon1 => q{Mittag}, midnight => q{Mitternacht}, afternoon2 => q{Nachmittag}, am => q{vorm.}, evening1 => q{Abend}, night1 => q{Nacht}, pm => q{nachm.}, morning2 => q{Vormittag}, morning1 => q{Morgen} }, 'AM PM stand alone narrow');
