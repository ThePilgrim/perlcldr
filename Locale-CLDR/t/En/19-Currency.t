...
$locale = Locale::CLDR->new('en_GB_u_cf_standard');
...
$locale = Locale::CLDR->new('en_GB_u_cf_standard_cu_eur');
is($locale->currency_format(), '¤#,##0.00', 'Currency format with standard default');
...
$locale = Locale::CLDR->new('en_GB_u_cf_account');
...
$locale = Locale::CLDR->new('en_GB_u_cf_account_cu_eur');
is($locale->currency_format(), '¤#,##0.00;(¤#,##0.00)', 'Currency format with account default');
