...
is($locale->format_number(12345678, '¤###,###'), '€12 345 678,00', 'Format number for currency with default currency');
...
$locale = Locale::CLDR->new('br_FR_u_cf_standard');
...
$locale = Locale::CLDR->new('br_FR_u_cf_standard_cu_gbp');
is($locale->currency_format(), '#,##0.00 ¤', 'Currency format with standard default');
...
$locale = Locale::CLDR->new('br_FR_u_cf_account');
...
is($locale->format_currency(-123456.78, 'cash'), '-123 456,78 €', 'Format currency with accountancy format, negitive number and cash rounding');$locale = Locale::CLDR->new('br_FR_u_cf_account');

$locale = Locale::CLDR->new('br_FR_u_cf_account_cu_gbp');
is($locale->currency_format(), '#,##0.00 ¤', 'Currency format with account default');
