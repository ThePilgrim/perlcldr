...
$locale = Locale::CLDR->new('ca_FR_u_cf_standard');
...
$locale = Locale::CLDR->new('ca_FR_u_cf_standard_cu_gbp');
is($locale->currency_format(), '#,##0.00 ¤', 'Currency format with standard default');
...
$locale = Locale::CLDR->new('ca_FR_u_cf_account');
...
$locale = Locale::CLDR->new('ca_FR_u_cf_account_cu_gbp');
is($locale->currency_format(), '#,##0.00 ¤;(#,##0.00 ¤)', 'Currency format with account default');
