...
is($locale->unit(2, 'arc-minute', 'short'), '2 arcmin', 'English short 2 arc minutes');
...
is($locale->unit(1, 'centimeter', 'narrow'), '1cm', 'English narrow 1 centimeter');
is($locale->unit(2, 'centimeter', 'narrow'), '2cm', 'English narrow 2 centimeters');
is($locale->unit(1, 'centimeter', 'short'), '1 cm', 'English short 1 centimeter');
is($locale->unit(2, 'centimeter', 'short'), '2 cm', 'English short 2 centimeters');
is($locale->unit(1, 'centimeter'), '1 centimeter', 'English long 1 centimeter');
is($locale->unit(2, 'centimeter'), '2 centimeters', 'English long 2 centimeters');
is($locale->unit(1, 'cubic-kilometer', 'narrow'), '1km³', 'English narrow 1 cubic kilometer');
is($locale->unit(2, 'cubic-kilometer', 'narrow'), '2km³', 'English narrow 2 cubic kilometers');
is($locale->unit(1, 'cubic-kilometer', 'short'), '1 km³', 'English short 1 cubic kilometer');
is($locale->unit(2, 'cubic-kilometer', 'short'), '2 km³', 'English short 2 cubic kilometers');
is($locale->unit(1, 'cubic-kilometer'), '1 cubic kilometer', 'English long 1 cubic kilometer');
is($locale->unit(2, 'cubic-kilometer'), '2 cubic kilometers', 'English long 2 cubic kilometers');
...
is($locale->unit(1, 'kilometer', 'narrow'), '1km', 'English narrow 1 kilometer');
is($locale->unit(2, 'kilometer', 'narrow'), '2km', 'English narrow 2 kilometers');
is($locale->unit(1, 'kilometer', 'short'), '1 km', 'English short 1 kilometer');
is($locale->unit(2, 'kilometer', 'short'), '2 km', 'English short 2 kilometers');
is($locale->unit(1, 'kilometer'), '1 kilometer', 'English long 1 kilometer');
is($locale->unit(2, 'kilometer'), '2 kilometers', 'English long 2 kilometers');
is($locale->unit(1, 'kilometer-per-hour', 'narrow'), '1kph', 'English narrow 1 kilometer per hour');
is($locale->unit(2, 'kilometer-per-hour', 'narrow'), '2kph', 'English narrow 2 kilometers per hour');
is($locale->unit(1, 'kilometer-per-hour', 'short'), '1 kph', 'English short 1 kilometer per hour');
is($locale->unit(2, 'kilometer-per-hour', 'short'), '2 kph', 'English short 2 kilometers per hour');
is($locale->unit(1, 'kilometer-per-hour'), '1 kilometer per hour', 'English long 1 kilometer per hour');
is($locale->unit(2, 'kilometer-per-hour'), '2 kilometers per hour', 'English long 2 kilometers per hour');
...
is($locale->unit(1, 'liter', 'narrow'), '1l', 'English narrow 1 liter');
is($locale->unit(2, 'liter', 'narrow'), '2l', 'English narrow 2 liters');
is($locale->unit(1, 'liter', 'short'), '1 l', 'English short 1 liter');
is($locale->unit(2, 'liter', 'short'), '2 l', 'English short 2 liters');
is($locale->unit(1, 'liter'), '1 liter', 'English long 1 liter');
is($locale->unit(2, 'liter'), '2 liters', 'English long 2 liters');
...
is($locale->unit(1, 'millimeter', 'narrow'), '1mm', 'English narrow 1 millimeter');
is($locale->unit(2, 'millimeter', 'narrow'), '2mm', 'English narrow 2 millimeters');
is($locale->unit(1, 'millimeter', 'short'), '1 mm', 'English short 1 millimeter');
is($locale->unit(2, 'millimeter', 'short'), '2 mm', 'English short 2 millimeters');
is($locale->unit(1, 'millimeter'), '1 millimeter', 'English long 1 millimeter');
is($locale->unit(2, 'millimeter'), '2 millimeters', 'English long 2 millimeters');
...
is($locale->unit(1, 'millimeter-per-second', 'narrow'), '1mm/s', 'English narrow 1 millimeter per second');
is($locale->unit(2, 'millimeter-per-second', 'narrow'), '2mm/s', 'English narrow 2 millimeters per second');
is($locale->unit(1, 'millimeter-per-second', 'short'), '1 mm/sec', 'English short 1 millimeter per second');
is($locale->unit(2, 'millimeter-per-second', 'short'), '2 mm/sec', 'English short 2 millimeters per second');
is($locale->unit(1, 'millimeter-per-second'), '1 millimeter per second', 'English long 1 millimeter per second');
is($locale->unit(2, 'millimeter-per-second'), '2 millimeters per second', 'English long 2 millimeters per second');
is($locale->unit(1, 'picometer', 'narrow'), '1pm', 'English narrow 1 picometer');
is($locale->unit(2, 'picometer', 'narrow'), '2pm', 'English narrow 2 picometers');
is($locale->unit(1, 'picometer', 'short'), '1 pm', 'English short 1 picometer');
is($locale->unit(2, 'picometer', 'short'), '2 pm', 'English short 2 picometers');
is($locale->unit(1, 'picometer'), '1 picometer', 'English long 1 picometer');
is($locale->unit(2, 'picometer'), '2 picometers', 'English long 2 picometers');
...
is($locale->unit(1, 'square-kilometer', 'narrow'), '1 km²', 'English narrow 1 square kilometer');
is($locale->unit(2, 'square-kilometer', 'narrow'), '2 km²', 'English narrow 2 square kilometers');
is($locale->unit(1, 'square-kilometer', 'short'), '1 km²', 'English short 1 square kilometer');
is($locale->unit(2, 'square-kilometer', 'short'), '2 km²', 'English short 2 square kilometers');
is($locale->unit(1, 'square-kilometer'), '1 square kilometer', 'English long 1 square kilometer');
is($locale->unit(2, 'square-kilometer'), '2 square kilometers', 'English long 2 square kilometers');
...
is($locale->unit(2, 'square-meter', 'short'), '2 m²', 'English short 2 square meters');
is($locale->unit(1, 'square-meter'), '1 square meter', 'English long 1 square meter');
is($locale->unit(2, 'square-meter'), '2 square meters', 'English long 2 square meters');
