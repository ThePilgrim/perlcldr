...
is_deeply ($days, [qw( man. tirs. ons. tors. fre. lør. søn. )], 'Day format abbreviated');
...
is_deeply ($days, [qw( man. tirs. ons. tors. fre. lør. søn. )], 'Day stand alone abbreviated');
...
is_deeply ($era, ['før Kristus', 'efter Kristus'], 'Era wide');
...
is_deeply ($era, ['før Kristus', 'efter Kristus' ], 'Era format wide');
...
is_deeply ($era, ['før Kristus', 'efter Kristus'], 'Era stand alone wide');
...
is($date_time_format, "EEEE 'den' d. MMMM y HH.mm.ss zzzz", 'Date Time Format Full');
