...
is($locale->format_currency(123456.78), 'US$123,456.78', 'Format currency with standard format, positive number and financial rounding');
is($locale->format_currency(123456.78, 'cash'), 'US$123,456.78', 'Format currency with standard format, positive number and cash rounding');
