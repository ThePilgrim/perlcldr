...
is($locale->unit(1, 'mass-microgram', 'narrow'), '1µg', 'English narrow 1 microgram');
is($locale->unit(2, 'mass-microgram', 'narrow'), '2µg', 'English narrow 2 micrograms');
is($locale->unit(1, 'mass-microgram', 'short'), '1 µg', 'English short 1 microgram');
is($locale->unit(2, 'mass-microgram', 'short'), '2 µg', 'English short 2 micrograms');
...
is($locale->unit(1, 'length-micrometer', 'narrow'), '1µm', 'English narrow 1 micrometer');
is($locale->unit(2, 'length-micrometer', 'narrow'), '2µm', 'English narrow 2 micrometers');
is($locale->unit(1, 'length-micrometer', 'short'), '1 µm', 'English short 1 micrometer');
is($locale->unit(2, 'length-micrometer', 'short'), '2 µm', 'English short 2 micrometers');
...
is($locale->unit(1, 'duration-microsecond', 'narrow'), '1µs', 'English narrow 1 microsecond');
is($locale->unit(2, 'duration-microsecond', 'narrow'), '2µs', 'English narrow 2 microseconds');
is($locale->unit(1, 'duration-microsecond', 'short'), '1 µs', 'English short 1 microsecond');
is($locale->unit(2, 'duration-microsecond', 'short'), '2 µs', 'English short 2 microseconds');
...
is($locale->unit(1, 'area-square-kilometer', 'narrow'), '1 km²', 'English narrow 1 square kilometre');
is($locale->unit(2, 'area-square-kilometer', 'narrow'), '2 km²', 'English narrow 2 square kilometres');
...
is($locale->unit(1, 'area-square-meter', 'narrow'), '1 m²', 'English narrow 1 square meter');
is($locale->unit(2, 'area-square-meter', 'narrow'), '2 m²', 'English narrow 2 square meters');
