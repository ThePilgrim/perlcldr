...
is_deeply ($months, [qw( Ion Chwef Mawrth Ebrill Mai Meh Gorff Awst Medi Hyd Tach Rhag )], 'Month format abbreviated');
...
is_deeply ($am_pm, { pm => q{PM}, noon => q{hanner dydd}, am => q{AM} }, 'AM PM format wide');
$am_pm = $locale->am_pm_format_abbreviated();
is_deeply ($am_pm, { pm => q{PM}, noon => q{hanner dydd}, am => q{AM} }, 'AM PM format abbreviated');
$am_pm = $locale->am_pm_format_narrow();
is_deeply ($am_pm, { pm => q{PM}, noon => q{n}, am => q{AM}}, 'AM PM format narrow');
$am_pm = $locale->am_pm_stand_alone_wide();
is_deeply ($am_pm, { pm => q{PM}, noon => q{hanner dydd}, am => q{AM}}, 'AM PM stand alone wide');
$am_pm = $locale->am_pm_stand_alone_abbreviated();
is_deeply ($am_pm, { pm => q{PM}, noon => q{hanner dydd}, am => q{AM}}, 'AM PM stand alone abbreviated');
$am_pm = $locale->am_pm_stand_alone_narrow();
is_deeply ($am_pm, { pm => q{PM}, noon => q{n}, am => q{AM} }, 'AM PM stand alone narrow');
