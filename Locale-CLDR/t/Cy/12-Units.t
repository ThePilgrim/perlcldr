...
is($locale->unit(1, 'arc-minute'), '1 munud', 'Welsh long 1 arc minute');
is($locale->unit(2, 'arc-minute'), '2 funud', 'Welsh long 2 arc minutes');
...
is($locale->unit(1, 'arc-second'), '1 eiliad', 'Welsh long 1 arc second');
is($locale->unit(2, 'arc-second'), '2 eiliad', 'Welsh long 2 arc seconds');
...
is($locale->unit(1, 'liter', 'narrow'), '1l', 'Welsh narrow 1 litre');
is($locale->unit(2, 'liter', 'narrow'), '2l', 'Welsh narrow 2 litres');
...
is($locale->unit(1, 'mile', 'short'), '1 filltir', 'Welsh short 1 mile');
is($locale->unit(2, 'mile', 'short'), '2 filltir', 'Welsh short 2 miles');
...
is($locale->unit(1, 'minute', 'narrow'), '1 mun', 'Welsh narrow 1 minute');
is($locale->unit(2, 'minute', 'narrow'), '2 mun', 'Welsh narrow 2 minutes');
...
is($locale->unit(1, 'millimeter-per-second', 'narrow'), '1mm/s', 'Welsh narrow 1 millimetre per second');
is($locale->unit(2, 'millimeter-per-second', 'narrow'), '2mm/s', 'Welsh narrow 2 millimetres per second');
is($locale->unit(1, 'millimeter-per-second', 'short'), '1 mm/s', 'Welsh short 1 millimetre per second');
is($locale->unit(2, 'millimeter-per-second', 'short'), '2 mm/s', 'Welsh short 2 millimetres per second');
is($locale->unit(1, 'millimeter-per-second'), '1 milimetr/s', 'Welsh long 1 millimetre per second');
is($locale->unit(2, 'millimeter-per-second'), '2 filimetr/s', 'Welsh long 2 millimetres per second');
...
is($locale->unit(1, 'square-foot', 'short'), '1 droedfedd ²', 'Welsh short 1 square foot');
is($locale->unit(2, 'square-foot', 'short'), '2 droedfedd ²', 'Welsh short 2 square feet');
