...
is_deeply ($am_pm, [qw( yb yh )], 'Islamic AM PM abbreviated');
...
is_deeply ($am_pm, { am => 'yb', pm => 'yh' }, 'Islamic AM PM format abbreviated');
$am_pm = $locale->am_pm_format_narrow();
is_deeply ($am_pm, { am => 'b', pm => 'h' }, 'Islamic AM PM format narrow');
$am_pm = $locale->am_pm_stand_alone_wide();
is_deeply ($am_pm, { am => 'yb', pm => 'yh', morning1 => 'y bore', noon => 'canol dydd', afternoon1 => 'y prynhawn', evening1 => 'yr hwyr', midnight => 'canol nos' }, 'Islamic AM PM stand alone wide');
$am_pm = $locale->am_pm_stand_alone_abbreviated();
is_deeply ($am_pm, { am => 'yb', pm => 'yh' }, 'Islamic AM PM stand alone abbreviated');
$am_pm = $locale->am_pm_stand_alone_narrow();
is_deeply ($am_pm, { am => 'yb', pm => 'yh' }, 'Islamic AM PM stand alone narrow');
...
is($day_period_data, 'yb', 'Islamic Day period data AM');
$day_period_data = $locale->get_day_period('1200');
is($day_period_data, 'yh', 'Islamic Day period data Noon');
$day_period_data = $locale->get_day_period('1210');
is($day_period_data, 'yh', 'Islamic Day period data PM');
